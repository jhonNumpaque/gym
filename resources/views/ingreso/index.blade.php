                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 p-2">
                            <form action="{{ route('GuardarIngreso') }}" method="post">
                                @csrf
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class='fa fa-edit icon-table' title='Modificar' href='javascript:getDataIngreso({{ $item->id }})'></a>
                                                        <a class='fa fa-trash icon-table' title='Eliminar' href='EliminarIngreso/{{ $item->id }}'></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
