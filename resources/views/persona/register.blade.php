            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('saveUser') }}" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            <label for="register_user" class="col-md-4 col-form-label text-md-right">Desea registrar como usuario?</label>

                            <div class="col-md-6">
                                <input id="register_user" type="checkbox" class="@error('register_user') is-invalid @enderror" name="register_user" checked="true">
